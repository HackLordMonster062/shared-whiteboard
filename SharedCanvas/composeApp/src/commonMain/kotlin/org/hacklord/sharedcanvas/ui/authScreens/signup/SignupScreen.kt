package org.hacklord.sharedcanvas.ui.authScreens.signup
...
import sharedcanvas.composeapp.generated.resources.LoginLink
import sharedcanvas.composeapp.generated.resources.Res
import sharedcanvas.composeapp.generated.resources.SignupForm
...
fun SignupScreen(
    ...
    BoxWithConstraints(
        ...
        AuthForm(
            authState = authState,
            onEvent = onEvent,
            onSubmitEvent = AuthEvent.Signup,
            background = painterResource(Res.drawable.SignupForm),
            modifier = Modifier
                .fillMaxSize(.45f)
        ...
        Row(
            ...
            Image(
                painter = painterResource(Res.drawable.LoginLink),
                contentDescription = null,
                modifier = Modifier
                    .clickable(
